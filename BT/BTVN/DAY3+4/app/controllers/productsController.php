...
class ProductController {
    ...
    public function create() {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $target_file = $target_dir . basename($_FILES["urlImage"]["name"]); // đường dẫn tới file
            move_uploaded_file($_FILES["urlImage"]["tmp_name"], $target_file);    
            $data = ['name' => $name, 'price' => $price, 'urlImage' => $target_file];
